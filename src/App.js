            ...
            React.createElement("div", {id: "moldura-topo"}, 
                React.createElement("div", {id: "topo"}, 
                    ...
                    React.createElement("div", {id: "identificacao-sistema", style: { 'float': 'none' }}, 
                        ...
                        React.createElement("div", {style: { 'float': 'right', 'color': '#fff', 'padding': '5px 10px 5px 15px' }}, "Versão 0.1-1"), 
                        React.createElement("h1", null, "Pragas Quarentenárias"), 
                        React.createElement("div", {style: { 'float': 'right', 'color': '#fff', 'padding': '5px 10px 5px 15px' }}, 
                            "Data: ", 
                            (new Date()).toLocaleDateString()), 
                        React.createElement("h2", null, "Consolidação da Lista de Pragas Quarentenárias para o Brasil")), 
